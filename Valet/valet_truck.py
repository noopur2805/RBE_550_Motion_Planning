...
agent_T = [[-1,21,21,-1],[-7.5,-7.5,7.5,7.5],[1,1,1,1]]
...
# car2 = [[car2_posx-padding,car2_posy-padding],
#       [car2_posx+car_width+padding,car2_posy-padding],
#       [car2_posx+car_width+padding,car2_posy+car_height+padding],
#        [car2_posx-padding,car2_posy+car_height+padding]]
...
def get_boundary(x,y,theta,car_type="car"):
    ...
    if car_type == "car":
        mat_mul = np.dot(homogeneous_matrix,agent_T)
    else:
